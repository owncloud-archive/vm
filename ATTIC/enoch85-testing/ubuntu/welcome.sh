...
echo "|									|"
echo "|    To run the startup script, just type: sudo -i			|"
echo "|    Password: owncloud (or the one you choose during install)		|"
echo "|									|"
...
echo "|    https://www.techandme.se/set-automatic-owncloud-updates/		|"
echo "|									|"
