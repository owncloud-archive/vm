...
if (is_file("/var/scripts/www/init-credentials.sh"))
  {
    ...
    print("<br></font><font size='+1'><a href='?zap=1' rel='nofollow'>Hide login credentials</a></font><p>");
  }
else
  {
...
<br>
<br><a href="https://www.techandme.se/publish-your-server-online" target="_blank">Here is a guide on how to publish your server online and change the certs.</a>
</div>
